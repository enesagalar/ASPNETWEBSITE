...
<body>
    <form id="form" runat="server">
        ...
        <section id="main_content_holder">
            <section id="page_template" style="padding-top:60px;">
               
                <div class="container services_container">
                    <div class="row page_title" style="margin:0 -20px 50px;">Deneme İnşaat'ı yakından tanıyın...</div>
                    <div class="row services_cols" style="padding-bottom:50px;">
                        <div class="col-xs-12 col-sm-4">
                            <div class="row service_ico">
                                <div class="ico_container" style="padding-top:15px;"><i class="fa fa-info" style="font-size:60px;"></i></div>
                            </div>
                            <div class="row service_title">Hakkımızda</div>
                            <div class="row service_desc" id="hakkimizdayazisi" runat="server"></div>
                        </div>
                        <div class="col-xs-12 col-sm-4">
                            <div class="row service_ico">
                                <div class="ico_container" style="padding-top:15px;"><i class="fa fa-info" style="font-size:60px;"></i></div>
                            </div>
                            <div class="row service_title">Vizyonumuz</div>
                            <div class="row service_desc" id="vizyonumuzyazisi" runat="server"></div>
                        </div>
                        <div class="col-xs-12 col-sm-4">
                            <div class="row service_ico">
                               <div class="ico_container" style="padding-top:15px;"><i class="fa fa-info" style="font-size:60px;"></i></div>
                            </div>
                            <div class="row service_title">Misyonumuz</div>
                            <div class="row service_desc" id="misyonumuzyazisi" runat="server"></div>
                        </div>
                    </div>
