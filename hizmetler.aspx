<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hizmetler.aspx.cs" Inherits="hizmetler" %>
    ...
    <form id="form1" runat="server">
        ...
        <section id="main_content_holder">
            <section id="page_template" style="padding-top: 60px;">
                ...
                <div class="row page_content" style="margin-top: -60px;">
                    <div class="container" style="padding-top: 80px;">
                        <h2 class="col-xs-12 col-sm-12 page_title ">Hizmetlerimiz</h2>

                        <div class="row blogs_and_widgets">

                            <div class="col-xs-12 col-sm-12 blogs" id="hizmetlerimiz" runat="server"></div>
