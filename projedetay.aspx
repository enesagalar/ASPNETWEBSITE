<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projedetay.aspx.cs" Inherits="projedetay" %>
                    ...
                    <div class="row blogs_and_widgets">
                        <div class="col-xs-12 col-sm-12 blogs">
                            <div class="row single_item single_blog_summery blog_style_gallery post_type_photography">
                                    ...
                                    <div class="like left">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lbtnbegen" runat="server" OnClick="btnbegen_Click" Style="font-weight: 500;" CausesValidation="false" ForeColor="#545347" Font-Size="14px"></asp:LinkButton>
                                ...
                                <div class="row" id="projeresimlerislayt" runat="server"></div>
                                <div class="row post_desc">
                                    <div class="row post_summery" id="projeaciklamasi" runat="server"></div>
