...
<body>
    <form id="form" runat="server">
        ...
        <section id="main_content_holder">
            <!--Slayt Gösterisi Başladı-->
            <section id="rv_slider">
                <div class="bannercontainer responsive" style="overflow: hidden;">
                    <div class="clr"></div>
                    <div class="banner">
                        <ul id="slayt" runat="server"></ul>
                    </div>
                </div>
            </section>
            <!--Slayt Gösterisi Bitti-->
            <!--Son Projeler Başladı-->
            <section id="multitem_carousal">
                <div class="container">
                    <h2>Projelerimizden Bazıları</h2>
                    <div id="second_slider" runat="server" class="owl-carousel"></div>
                    <p>Deneme İnşaat tarafından üretilen en son projelerden bazıları yukarıda sıralanmaktadır. Detaylı bilgisini görmek istediğiniz proje üzerine tıklayabilirsiniz. Tüm projelerimize ulaşmak için <a href="tumprojeler.aspx" target="_self">tıklayınız.</a></p>
                </div>
            </section>
            <!--Son Projeler Bitti-->
            <!--Firmayı Tanıyın Başladı-->
            <section id="story_of_day">
                <div class="container">
