                ...
                <section id="main_content_holder">
                    ...
                    <section id="page_template">
                        <div class="row page_header">
                            ...
                            <h3 style="margin-top: 10px;">Bu sayfa üzerinden üye kaydı onaylanmış kullanıcılar bilgilerini girerek üyelere özel içeriklere ulaşabilirler...</h3>
                        </div>
                        <div class="row contact_tabs">
                            <div class="container" style="padding: 10px !important;">
                                <div class="row heading">

                                    <p>Kullanıcı adı ve parolanızı doğru girerek "GİRİŞ" butonuna tıklayınız.</p>
                                </div>
                                        ...
                                        <div class="tab-pane active" id="mail_form">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 text-center">
                                                    ...
                                                    <asp:Button ID="btngirisyap" runat="server" Text="GİRİŞ" class="btn btn-default" OnClick="btngirisyap_Click" />
                                                </div>
                                                <div class="col-xs-12 col-sm-12 text-center" style="margin-top: 15px;">
                                                    <asp:Label ID="lblislemtamam" runat="server" Text="Giriş İşlemi Başarılı, Paneliniz hazırlanıyor, Lütfen Bekleyiniz." CssClass="alert alert-success" Visible="false" Font-Size="14px"></asp:Label>
                                                </div>
                                                <div class="col-xs-12 col-sm-12 text-center" style="margin-top: 15px;">
                                                    <asp:Label ID="lblislemtamamdegil" runat="server" Text="Giriş İşlemi Başarısız" CssClass="alert alert-danger" Visible="false" Font-Size="14px"></asp:Label>
                                                </div>
                                            </div>
